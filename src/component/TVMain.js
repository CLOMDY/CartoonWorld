                    ...
                    <div class="col smallCol">
                        <a href="#!" style={{ textDecoration: "none", color: "white" }}>
                            <div class="thumb1">
                                ...
                                <img class="iconImg1" src="./THUMBNAIL/image-213x316 (7).jpg" alt="Generator Rex Thumbnail" />
                            </div>
                    ...
                    <div class="col smallCol">
                        <a href="#!" style={{ textDecoration: "none", color: "white" }}>
                            <div class="thumb1">
                                ...
                                <img class="iconImg1" src="./THUMBNAIL/image-213x316 (9).jpg" alt="Teen Titans Thumbnail" />
                            </div>
                            <div class="titleName1">
                                Teen Titans
                            </div>
                    ...
                    <div class="col smallCol">
                        <a href="#!" style={{ textDecoration: "none", color: "white" }}>
                            <div class="thumb1">
                                ...
                                <img class="iconImg1" src="./THUMBNAIL/image-213x316 (10).jpg" alt="Teenage Mutant Ninja Turtles Thumbnail" />
                            </div>
                            <div class="titleName1">
                    ...
                    <div class="col smallCol">
                        <a href="#!" style={{ textDecoration: "none", color: "white" }}>
                            <div class="thumb1">
                                ...
                                <img class="iconImg1" src="./THUMBNAIL/image-213x316 (5).jpg" alt="Batman: The Animated Series Thumbnail" />
                            </div>
                            <div class="titleName1">
                    ...
                    <div class="col smallCol">
                        <a href="#!" style={{ textDecoration: "none", color: "white" }}>
                            <div class="thumb1">
                                ...
                                <img class="iconImg1" src="./THUMBNAIL/image-213x316 (1).jpg" alt="Kim Possible Thumbnail" />
                            </div>
                            <div class="titleName1">
                                Kim Possible
                            </div>
                    ...
                    <div class="col smallCol">
                        <a href="#!" style={{ textDecoration: "none", color: "white" }}>
                            <div class="thumb1">
                                ...
                                <img class="iconImg1" src="./THUMBNAIL/image-213x316 (2).jpg" alt="Scooby-Doo! Mystery Incorporated Thumbnail" />
                            </div>
                            <div class="titleName1">
                    ...
                    <div class="col smallCol">
                        <a href="#!" style={{ textDecoration: "none", color: "white" }}>
                            <div class="thumb1">
                                ...
                                <img class="iconImg1" src="./THUMBNAIL/image-213x316 (11).jpg" alt="The Avengers: Earth's Mightiest Heroes Thumbnail" />
                            </div>
                            <div class="titleName1">
                    ...
                    <div class="col smallCol">
                        <a href="#!" style={{ textDecoration: "none", color: "white" }}>
                            <div class="thumb1">
                                ...
                                <img class="iconImg1" src="./THUMBNAIL/image-213x316 (4).jpg" alt="Samurai Jack Thumbnail" />
                            </div>
                            <div class="titleName1">
                                Samurai Jack
                            </div>
